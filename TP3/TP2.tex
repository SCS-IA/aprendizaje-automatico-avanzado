...
Las millones de páginas están guardadas en el lenguaje de marcado (HTML).
	...
	\begin{frame}[fragile]{Implementación 'a' - Obtención del Vocabulario}
	...
	% ==========================================
	\begin{frame}[fragile]{Implementación 'p' - Obtención del Vocabulario}
		...
		\end{lstlisting}
				...
				Proceso:
		\begin{itemize}
			\item Se crea un Tokenizer vació.
			\item Se llama a \texttt{fit\_on\_texts} pasándole todas las oraciones del corpus.
			\item El tokenizer construye el vocabulario.
		\end{itemize}
